  ...
  return (
    <div className="db-page">
      ...
      <div className="db-header">
        ...
        <p className="db-subheading">Discover pre-vetted candidates with verified efficiency scores</p>
      </div>

      {/* Bento stat grid */}
      <div className="db-bento-grid">
        <div className="db-stat-card db-stat-card--gold" style={{ gridColumn: 'span 2' }}>
        ...
        <div className="db-stat-card db-stat-card--stone">
      ...
      <div className="db-filter-bar">
        <div className="db-filter-chips">
          <span className="db-chip db-chip--active">
            All Tech Stacks
            <span className="material-symbols-outlined" style={{ fontSize: 16 }}>expand_more</span>
          </span>
          <span className="db-chip">Remote Only</span>
          <span className="db-chip">High Efficiency</span>
        </div>
        ...
        {!loading && !error && displayCandidates.length > 0 && (
          <div className="db-card-grid">
            {displayCandidates.map((c, i) => (
              <CandidateCard key={c.id} candidate={c} viewMode="stack" index={i} />
            ))}

            {/* Promo card */}
            <div className="db-promo-card pikt-card">
              ...
              <button className="db-promo-btn" onClick={() => navigate('/marketplace/results')}>Get Started</button>
      ...
      {!loading && candidates.length > 6 && (
        <div className="db-load-more">
          <button className="db-load-btn" onClick={() => navigate('/marketplace/results')}>View All Candidates</button>
      ...
      <div className="db-fabs">
        <div className="db-fab-wrap">
          <button className="db-fab db-fab--gold" title="Auto Match">
            <span className="material-symbols-outlined">bolt</span>
          </button>
        </div>
        <div className="db-fab-wrap">
          <button className="db-fab db-fab--green" title="Advanced Filters" onClick={() => navigate('/marketplace/results')}>
